        ...
        <div className={`${styles.boxGrid}`}>
          <Link href="/foto" className={styles.box}>
            ...
            <div className={styles.titleBox}>
              <p className={styles.description}>Zdjęcia, które zatrzymają najważniejsze chwile w Twoim życiu.</p>
          ...
          <Link href="/film" className={styles.box}>
            ...
            />
            <div className={styles.titleBox}>
              <p className={styles.description}>Filmy do których będziesz wracać z chęcią wraz z rodziną i przyjaciółmi.</p>
              <button className={styles.button}>
                <Image
                  src="/arrow-right.svg"
                  alt="arrow"
